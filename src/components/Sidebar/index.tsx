    ...
    menuItems: [
      {
        children: [
          ...
          },
          {
            ...
            route: "/",
            children: [
              { label: "Vehicle Management", route: "/vehicleManagement" },
              { label: "Branch Mangement", route: "/branchManagement" },
              { label: "Employee Management", route: "/employeeManagement" },
              { label: "Consignor Management", route: "/consignorManagement" },
              { label: "Consignee Management", route: "/consigneeManagement" },
              { label: "Broker Management", route: "/brokerManagement" },
            ],
          },
        ],
      },
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center justify-between gap-2 rounded-full px-6 ">
          <Link href="/">
            <Image
              width={300}
              height={200}
