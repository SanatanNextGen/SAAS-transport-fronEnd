...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | SanatanExpress - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page SanatanExpress Dashboard Template",
  // other metadata
};
