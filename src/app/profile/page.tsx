...
export const metadata: Metadata = {
  title: "Next.js Profile | SanatanExpress - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for SanatanExpress - Next.js Tailwind CSS Admin Dashboard Template",
};
